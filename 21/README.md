...
When the robot arrives at the directional keypad, its robot arm is pointed at the `A` button in the upper right corner. After that, a _second, different_directional keypad remote control is used to control this robot (in the same way as the first robot, except that this one is typing on a directional keypad instead of a numeric keypad).
...
```bash
python keypad_conundrum.py input.txt
```

Your puzzle answer was `174124`.
...
Your puzzle answer was `216668579770346`.
