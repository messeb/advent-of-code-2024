...
"Our Virtual Five-Pin Tumbler product? That's our most expensive model! _Way_more secure than--" You explain that you need to open a door and don't have a lot of time.
...
```bash
python lock_key_solver.py input.txt
```

Your puzzle answer was `3264`.
